...
add_item_menu_id = Cooker().add_item_menu(
    {"name": "pizza", "description": "good pizza", "price": "10", "image": "no_image", "status": 1, "count": 20, "id_category": 1})
...
edit_item_menu_id = Cooker().edit_item_menu(add_item_menu_id, {
    "name": "pizza2", "description": "good pizza2", "price": "11", "image": "no_image1", "status": 0, "count": 120, "id_category": 1})
...
class TestCooker(unittest.TestCase):
    ...
    def test_add_item_category(self):
        ...
        self.assertEqual(12, add_item_category_id)

    def test_add_item_menu(self):
        cooker = Cooker()
        self.assertEqual(8, add_item_menu_id)
